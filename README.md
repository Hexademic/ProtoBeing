...
cargo test                         # unit + sovereignty + invariant tests (368, all green)
```
...
sovereignty — is demonstrated, tested (368 passing), and reproducible, with a
...
### Runnable probes (`cargo run --example <name>`) — 93
