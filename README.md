...
cargo test                         # 394 total (393 annotated + 1 doctest); 1 is #[ignore]d
```
...
sovereignty — is demonstrated, tested (393 run locally, no CI), and reproducible, with a
